...
if dataset == 1:
    _file = r"C:\Users\Frede\Speciale\Digital-Twin\src_operational\Virtual_sensing\Experimental\Filtered_data_3_sensors\data_predicted_3_sensors_high.txt" # Path to the txt file 
elif dataset == 2:
    _file = r"C:\Users\Frede\Speciale\Digital-Twin\src_operational\Virtual_sensing\Experimental\Filtered_data_3_sensors\data_predicted_3_sensors_nodamp.txt" # Path to the txt file     
