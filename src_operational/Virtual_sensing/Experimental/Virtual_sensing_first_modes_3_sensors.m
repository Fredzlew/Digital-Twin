...
if q == 1
    % Load data
    xm_0_cut = readNPY('.\Filtered_data_3_sensors\data_filt_first_modes_3_sensors_high.npy');
    %xm_ori = readNPY('.\Filtered_data_3_sensors\data_filt_first_modes_3_sensors_high.npy');
    xm_ori = readNPY('.\Filtered_data_3_sensors\data_filt_first_modes_all_sensorss_high.npy');
    % loading mode shapes
...
elseif q == 2
    % Load data
    xm_0_cut = readNPY('.\Filtered_data_3_sensors\data_filt_first_modes_3_sensors_no_damp.npy');
    %xm_ori = readNPY('.\Filtered_data_3_sensors\data_filt_first_modes_3_sensors_no_damp.npy');
    xm_ori = readNPY('.\Filtered_data_3_sensors\data_filt_first_modes_all_sensors_no_damp.npy');
    % loading mode shapes
