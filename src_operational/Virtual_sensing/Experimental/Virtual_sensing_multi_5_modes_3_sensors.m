...
if q == 1
    % Load data
    xm_mode1 = readNPY('.\Filtered_data_3_sensors\data_filt_mode1_3_sensors_high.npy');
    xm_mode2 = readNPY('.\Filtered_data_3_sensors\data_filt_mode2_3_sensors_high.npy');
    xm_mode3 = readNPY('.\Filtered_data_3_sensors\data_filt_mode3_3_sensors_high.npy');
...
elseif q == 2
    % Load data
    xm_mode1 = readNPY('.\Filtered_data_3_sensors\data_filt_mode1_3_sensors_no_damp.npy');
    xm_mode2 = readNPY('.\Filtered_data_3_sensors\data_filt_mode2_3_sensors_no_damp.npy');
    xm_mode3 = readNPY('.\Filtered_data_3_sensors\data_filt_mode3_3_sensors_no_damp.npy');
    ...
    %filename = load('..\..\Model_updating\Sensitivity_method\data_updated_par_sens_3_sensors\Eigenvalue_residual_3_sensors_no_damp.mat');
    U = filename.U;
end
...
[xp1,qt1] = VirtualSensVal_3_sensors(xm_mode1,U,num_ms,im,ls);
...
% Calculate displacement at predicted locations
[xp2,qt2] = VirtualSensVal_3_sensors(xm_mode2,U,num_ms,im,ls);
...
% Calculate displacement at predicted locations
[xp3,qt3] = VirtualSensVal_3_sensors(xm_mode3,U,num_ms,im,ls);
...
% Calculate displacement at predicted locations
[xp4,qt4] = VirtualSensVal_3_sensors(xm_mode4,U,num_ms,im,ls);
...
% Calculate displacement at predicted locations
[xp5,qt5] = VirtualSensVal_3_sensors(xm_mode5,U,num_ms,im,ls);
