...
dataSSIFreq = load('.\data_updated_par_sens_3_sensors\Eigenvalue_residual_3_sensors_high.mat'); % SSI FREQ
K_SSI_freq = dataSSIFreq.knew';

dataSSImode = load('.\data_updated_par_sens_3_sensors\Mode_shape_residual_3_sensors_high.mat'); % SSI modes
K_SSI_mode = dataSSImode.knew';

dataSSIFreqmode = load('.\data_updated_par_sens_3_sensors\Eigenvalue_Mode_shape_residual_3_sensors_high.mat'); % SSI modes and freq
...
xx = input(promptt);
if xx == 1
    data = load('.\data_updated_par_sens_3_sensors\Eigenvalue_residual_3_sensors_high.mat'); % SSI FREQ
    fn = data.fn;
    K = data.Knew;
    U = data.U;
    L_data = load('.\data_updated_par_sens_3_sensors\Eigenvalue_residual_L_curve_3_sensors_high.mat');
    Jeps = L_data.Jeps;
    Jthe = L_data.Jthe;
    err = data.err;
    figure 
    ...
    hold off
elseif xx == 2
    data = load('.\data_updated_par_sens_3_sensors\Mode_shape_residual_3_sensors_high.mat'); % SSI modes
    fn = data.fn;
    K = data.Knew;
    U = data.U;
    L_data = load('.\data_updated_par_sens_3_sensors\Mode_shape_residual_L_curve_3_sensors_high.mat');
    Jeps = L_data.Jeps;
    Jthe = L_data.Jthe;
    acc = data.acc;
    ...
    hold off
elseif xx == 3
    data = load('.\data_updated_par_sens_3_sensors\Eigenvalue_Mode_shape_residual_3_sensors_high.mat'); % SSI EIL  FREQ and modes
    fn = data.fn;
    K = data.Knew;
    U = data.U;
    L_data = load('.\data_updated_par_sens_3_sensors\Eigenvalue_Mode_shape_residual_L_curve_3_sensors_high.mat');
    Jeps = L_data.Jeps;
    Jthe = L_data.Jthe;
    acc = data.acc;
    err = data.err;
