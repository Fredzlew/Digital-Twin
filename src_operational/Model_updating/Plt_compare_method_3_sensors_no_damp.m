...
% Costfunctions
dataSSIFreq = load('.\Costfunctions\data_updated_par_3_sensors\SSIfreq_3_sensors_no_damp.mat'); % SSI FREQ
K_SSI_freq = dataSSIFreq.k;

dataSSImode = load('.\Costfunctions\data_updated_par_3_sensors\SSImode_3_sensors_no_damp.mat'); % SSI modes
K_SSI_mode = dataSSImode.k;

dataSSImodemac = load('.\Costfunctions\data_updated_par_3_sensors\SSImode_mac_3_sensors_no_damp.mat'); % SSI modes
K_SSI_mode_mac = dataSSImodemac.k;


dataSSIFreqmode = load('.\Costfunctions\data_updated_par_3_sensors\SSIfreqmode_3_sensors_no_damp.mat'); % SSI FREQ and modes
K_SSI_freq_mode = dataSSIFreqmode.k;

dataSSIfreqmodeEIL = load('.\Costfunctions\data_updated_par_3_sensors\SSIfreqmodeEIL_3_sensors_no_damp.mat'); % SSI modes
K_SSI_freqmodeEIL = dataSSIfreqmodeEIL.k;


% Sensitivity method
dataSSIFreq_sens = load('.\Sensitivity_method\data_updated_par_sens_3_sensors\Eigenvalue_residual_3_sensors_no_damp.mat'); % SSI FREQ
K_SSI_freq_sens = dataSSIFreq_sens.knew';

dataSSImode_sens = load('.\Sensitivity_method\data_updated_par_sens_3_sensors\Mode_shape_residual_3_sensors_no_damp.mat'); % SSI modes
K_SSI_mode_sens = dataSSImode_sens.knew';

dataSSIFreqmode_sens = load('.\Sensitivity_method\data_updated_par_sens_3_sensors\Eigenvalue_Mode_shape_residual_3_sensors_no_damp.mat'); % SSI modes and freq
