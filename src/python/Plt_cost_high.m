...
dataSSIFreq = load('costfunupdateSSIfreq_py_high.mat'); % SSI FREQ
K_SSI_freq = diag(dataSSIFreq.K)';
stivhed = dataSSIFreq.stivhed';

dataSSImode = load('costfunupdateSSImode_py_high.mat'); % SSI modes
K_SSI_mode = diag(dataSSImode.K)';


dataSSIFreqmode = load('costfunupdateSSIfreqmode_py_high.mat'); % SSI FREQ and modes
K_SSI_freq_mode = diag(dataSSIFreqmode.K)';

dataSSIfreqmodeEILJAN = load('costfunupdateSSIfreqmodeEILJAN_py_high.mat'); % SSI modes
...
x = input(promptt);
if x == 1
    data = load('costfunupdateSSIfreq_py_high.mat'); % SSI FREQ
    OMAphi = data.OMAphi;
    ...
    H = data.H;
elseif x == 2
    data = load('costfunupdateSSImode_py_high.mat'); % SSI modes
    OMAphi = data.OMAphi;
    OMAfreq = data.OMAfreq;
    fn = data.fn;
    K = data.K;
    ...
    H = data.H;
elseif x == 3
    data = load('costfunupdateSSIfreqmode_py_high.mat'); % SSI FREQ and modes
    OMAphi = data.OMAphi;
    OMAfreq = data.OMAfreq;
    fn = data.fn;
    K = data.K;
    ...
    H = data.H;
elseif x == 4
    data = load('costfunupdateSSIfreqmodeEILJAN_py_high.mat'); % SSI EIL JAN FREQ and modes
    OMAphi = data.OMAphi;
    OMAfreq = data.OMAfreq;
    fn = data.fn;
    K = data.K;
