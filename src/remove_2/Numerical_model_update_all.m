...
elseif Stif == 2
    save('.\data\costfunupdateERAfreq.mat','OMAphi','OMAfreq','K','Km','x','phi','stivhed','H','U','fn');
elseif Stif == 3
...
elseif Stif == 5
    save('.\data\costfunupdateERAmode.mat','OMAphi','OMAfreq','K','Km','x','phi','stivhed','H','U','fn');
elseif Stif == 6
...
elseif Stif == 8
    save('.\data\costfunupdateERAfreqmode.mat','OMAphi','OMAfreq','K','Km','x','phi','stivhed','H','U','fn');
elseif Stif == 9
    save('.\data\costfunupdateFDDfreqmode.mat','OMAphi','OMAfreq','K','Km','x','phi','stivhed','H','U','fn');
elseif Stif == 10
    save('.\data\costfunupdateSSIfreqmodeEIL.mat','OMAphi','OMAfreq','K','Km','x','phi','stivhed','H','U','fn');
elseif Stif == 11
    save('.\data\costfunupdateERAfreqmodeEIL.mat','OMAphi','OMAfreq','K','Km','x','phi','stivhed','H','U','fn');
elseif Stif == 12
    save('.\data\costfunupdateFDDfreqmodeEIL.mat','OMAphi','OMAfreq','K','Km','x','phi','stivhed','H','U','fn');
elseif Stif == 13
    save('.\data\costfunupdateSSIfreqmodeEILJAN.mat','OMAphi','OMAfreq','K','Km','x','phi','stivhed','H','U','fn');
elseif Stif == 14
    save('.\data\costfunupdateERAfreqmodeEILJAN.mat','OMAphi','OMAfreq','K','Km','x','phi','stivhed','H','U','fn');
elseif Stif == 15
