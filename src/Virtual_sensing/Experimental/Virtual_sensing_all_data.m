...
if q == 1
    ...
    xm_ori = readNPY('.\Filtered_data\data_filt_all_high.npy');
    % loading mode shapes
...
elseif q == 2
    ...
    xm_ori = readNPY('.\Filtered_data\data_filt_all_no_damp.npy');
    % loading mode shapes
...
MAE = sum(abs(xm_ori(vs,:)-xp(vs,:)))/size(xm_ori,2)/std(xm_ori(vs,:));
...
if q == 1
    ...
    writetable(T_pred,'C:\Users\Frede\OneDrive - Danmarks Tekniske Universitet\Kandidat\Data\Kap10_virtuel_sensing_pred_all_data_highdamp.csv','Delimiter',';')
    writetable(T_fft,'C:\Users\Frede\OneDrive - Danmarks Tekniske Universitet\Kandidat\Data\Kap10_virtuel_sensing_fft_all_data_highdamp.csv','Delimiter',';')
elseif q == 2
    ...
    writetable(T_pred,'C:\Users\Frede\OneDrive - Danmarks Tekniske Universitet\Kandidat\Data\Kap10_virtuel_sensing_pred_all_data_nodamp.csv','Delimiter',';')
    writetable(T_fft,'C:\Users\Frede\OneDrive - Danmarks Tekniske Universitet\Kandidat\Data\Kap10_virtuel_sensing_fft_all_data_nodamp.csv','Delimiter',';')
end