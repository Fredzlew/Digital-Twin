...
% SSI
phiOMA =  [0.3034    0.6137    0.7760    0.9744    1.0000
    0.7332    1.0000    0.4656   -0.3042   -0.8046
    1.0000    0.2127   -0.8404   -0.4059    0.6585
    1.0000   -0.9640   -0.0218    0.9037   -0.5401
    0.4855   -0.8445    1.0000   -0.9874    0.3962];
% Stiffness matrix
for i = 1:4
    K(i,i) = k(i)+k(i+1);
    K(i,i+1) = -k(i+1);
