...
if q == 1
    save('.\data_updated_par_sens\Eigenvalue_Mode_shape_residual_stiffmass_high.mat','Knew','U','fn');
elseif q == 2
    save('.\data_updated_par_sens\Eigenvalue_Mode_shape_residual_stiffmass_no_damp.mat','Knew','U','fn');
end
