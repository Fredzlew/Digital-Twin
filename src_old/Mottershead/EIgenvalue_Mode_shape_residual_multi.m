...
SSIFreq = readNPY('..\python\data\Modal_parameters_anela\SSIfreq_nodamp_split.npy');

SSIomega = SSIFreq * 2 * pi;
% squared
omegasq_m = SSIomega.^2;

SSIphi = readNPY('..\python\data\Modal_parameters_anela\SSIphi_nodamp_split.npy');
...
save('..\Virtual_Sensing\data_sens\Eigenvalue_modeshape_residual_stiff_nodamp_split.mat','U','fn');
