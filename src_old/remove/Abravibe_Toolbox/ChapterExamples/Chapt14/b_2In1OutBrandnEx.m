% b_2In1OutBrandnEx   Simulate 2-in-1-out system excited by burst random noise
% 
...
% This example is similar to that used for Figure 14.11 in Brandt
...
[Gxx,Gyx,Gyy,fb,NBb]=time2xmtrx([x1 x2],y,fs,boxcar(Nburst));
